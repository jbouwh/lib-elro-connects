...
STATE_TEMPERATURE_ALARM = "TEMPERATURE ALARM"
STATE_TEST_ALARM = "TEST ALARM"
STATE_UNKNOWN = "UNKNOWN"

STATES_ON = (STATE_ALARM, STATE_FIRE_ALARM, STATE_TEST_ALARM, STATE_TEMPERATURE_ALARM)
...
DEVICE_STATE = {
    ...
    "11": STATE_FAULT,
    "12": STATE_FAULT,
    "13": STATE_LOW_BATTERY,
    "15": STATE_SILENCE,
    "17": STATE_TEST_ALARM,
    "18": STATE_TEMPERATURE_ALARM,
    "19": STATE_FIRE_ALARM,
    "22": STATE_FIRE_ALARM,
    "66": STATE_OPEN, # OPEN windows sensor
    "1B": STATE_SILENCE,
    "BB": STATE_TEST_ALARM,
    "55": STATE_ALARM,  # OPEN window sensor
    "AA": STATE_CLOSED,  # CLOSED window sensor
    "FE": STATE_UNKNOWN,
    "FF": STATE_OFFLINE,
}
